...
### src/youtube/templates/index.html:
```
mkdir src/youtube/templates/
```
```
touch src/youtube/templates/youtube/index.html
```
```
{% extends 'base.html' %}
...
### src/youtube/templates/download.html:
```
touch src/youtube/templates/youtube/download.html
```
```
{% extends 'base.html' %}
